...
class MaterialMeta extends \ProtobufMessage
{
    ...
    public function reset()
    {
        ...
        $this->values[self::AD_TITLE] = null;
    }
    ...
    {
        return (integer)$this->get(self::CREATIVE_TYPE);
    }
    ...
    {
        return (integer)$this->get(self::INTERACTION_TYPE);
    }
    ...
    {
        return (string)$this->get(self::CLICK_URL);
    }
    ...
    {
        return (integer)$this->get(self::APP_SIZE);
    }
    ...
    {
        return (string)$this->get(self::VIDEO_URL);
    }
    ...
    {
        return (integer)$this->get(self::VIDEO_DURATION);
    }

    /**
     * Sets value of 'meta_index' property
     *
     * @param \Mobads\Apiv5\MetaIndex $value Property value
     *
     * @return null
     */
    public function setMetaIndex(\Mobads\Apiv5\MetaIndex $value=null)
    {
    ...
    {
        return (integer)$this->get(self::MATERIAL_WIDTH);
    }
    ...
    {
        return (integer)$this->get(self::MATERIAL_HEIGHT);
    }
    ...
    {
        return (string)$this->get(self::BRAND_NAME);
    }

    /**
     * Sets value of 'ad_title' property
     *
     * @param string $value Property value
     *
     * @return null
    ...
    {
        return $this->set(self::AD_TITLE, $value);
    }

    /**
     * Returns value of 'ad_title' property
     *
     * @return string
     */
    public function getAdTitle()
    {
        return (string)$this->get(self::AD_TITLE);
    }
}
}
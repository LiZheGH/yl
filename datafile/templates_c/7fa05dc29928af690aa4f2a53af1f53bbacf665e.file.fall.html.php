<?php /* Smarty version Smarty-3.1.13, created on 2017-10-15 05:26:11
         compiled from "/private/var/www/yl/application/views/admin/examine/fall.html" */ ?>
<?php /*%%SmartyHeaderCode:96327046859e280f3b59596-85365194%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7fa05dc29928af690aa4f2a53af1f53bbacf665e' => 
    array (
      0 => '/private/var/www/yl/application/views/admin/examine/fall.html',
      1 => 1507867954,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '96327046859e280f3b59596-85365194',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59e280f3bbaff9_17087059',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59e280f3bbaff9_17087059')) {function content_59e280f3bbaff9_17087059($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['VIEW_DIR']->value)."common/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
	...
	<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
      <div class="portlet box blue-madison">
        <div class="portlet-title">
          <div class="caption"> <i class="fa fa-globe"></i>异常事件审核-跌倒坠床报告</div>
        </div>
        <div class="portlet-body">
        	<div id="toolbar1" style="margin-bottom:0px;">
				<!-- <button class="btn btn-primary btn-sm" onClick="showModal();">&nbsp;&nbsp;新增&nbsp;&nbsp;</button> -->
		   	</div>
		   <table id="tableId" data-url="/Examine/ajaxFallList" data-sort-name="id" data-sort-order="desc" data-toggle="table"
...
"><?php echo $_smarty_tpl->tpl_vars['section']->value;?>
					...
					<div class="form-group">
						...
						<div class="col-sm-9 controls" style="line-height: 40px;">
							...
							<label class="radio" style="float:left;margin-left: 40px;">
		                    	<input type="radio" class="form-control" name="incident_link" value="行走">行走</label>
							<label class="radio" style="float:left;margin-left: 40px;">
								<input type="radio" class="form-control" name="incident_link" value="站立">站立</label>
							<label class="radio" style="float:left;margin-left: 40px;">
								<input type="radio" class="form-control" name="incident_link" value="上下病床">上下病床</label>
							<label class="radio" style="float:left;margin-left: 40px;">
								<input type="radio" class="form-control" name="incident_link" value="躺卧病床">躺卧病床</label>
							<label class="radio" style="float:left;margin-left: 40px;">
								<input type="radio" class="form-control" name="incident_link" value="坐床旁椅">坐床旁椅</label>
							<label class="radio" style="float:left;margin-left: 40px;">
								<input type="radio" class="form-control" name="incident_link" value="坐轮椅">坐轮椅</label>
							<label class="radio" style="float:left;margin-left: 40px;">
								<input type="radio" class="form-control" name="incident_link" value="沐浴">沐浴</label>
							<label class="radio" style="float:left;margin-left: 40px;">
								<input type="radio" class="form-control" name="incident_link" value="如厕">如厕</label>
							<label class="radio" style="float:left;margin-left: 21px;">
								<input type="radio" class="form-control" name="incident_link" value="其他">其他</label>
	                    </div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9 controls" style="line-height: 40px;">
	                    	...
	                    	<label class="radio" style="float:left;margin-left: 40px;">
								<input type="radio" class="form-control" name="incident_location" value="厕所">厕所</label>
	                    	<label class="radio" style="float:left;margin-left: 40px;">
	                    	...
	                    	<label class="radio" style="float:left;margin-left: 40px;">
								<input type="radio" class="form-control" name="incident_location" value="床旁">床旁</label>
	                    	<label class="radio" style="float:left;margin-left: 40px;">
								<input type="radio" class="form-control" name="incident_location" value="楼梯">楼梯</label>
	                    	<label class="radio" style="float:left;margin-left: 21px;">
								<input type="radio" class="form-control" name="incident_location" value="楼外">楼外</label>
	                    	<label class="radio" style="float:left;margin-left: 40px;">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">受伤分级</label>
						<div class="col-sm-9 controls" style="line-height: 40px;">
							<label class="radio" style="float:left;margin-left: 20px;">
								<input type="radio" class="form-control" name="injury_classification" value="无">无</label>
	                    	<label class="radio" style="float:left;margin-left: 40px;">
	                    		<input type="radio" class="form-control" name="injury_classification" value="轻伤">轻伤</label>
	                    	<label class="radio" style="float:left;margin-left: 40px;">
	                    		<input type="radio" class="form-control" name="injury_classification" value="中度伤">中度伤</label>
	                    	<label class="radio" style="float:left;margin-left: 40px;">
	                    		<input type="radio" class="form-control" name="injury_classification" value="重伤">重伤</label>
	                    	<label class="radio" style="float:left;margin-left: 40px;">
	                    		<input type="radio" class="form-control" name="injury_classification" value="死亡">死亡</label>
	                    	<label class="radio" style="float:left;margin-left: 40px;">
	                    		<input type="radio" class="form-control" name="injury_classification" value="无法确定">无法确定</label>
	                    </div>
					</div>
					<div class="form-group">
...
"><?php echo $_smarty_tpl->tpl_vars['section']->value;?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">患者治理能力</label>
						<div class="col-sm-9 controls" style="line-height: 40px;">
							<label class="radio" style="float:left;margin-left: 20px;">
								<input type="radio" class="form-control" name="governance_capability" value="治理">治理</label>
	                    	<label class="radio" style="float:left;margin-left: 40px;">
	                    		<input type="radio" class="form-control" name="governance_capability" value="部分依赖">部分依赖</label>
	                    	<label class="radio" style="float:left;margin-left: 40px;">
	                    		<input type="radio" class="form-control" name="governance_capability" value="完全依赖">完全依赖</label>
	                    </div>
					</div>
					<div class="form-group">
		...
		<div class="modal-content">
			...
			<form role="form" id="analysisForm" class="form-horizontal" method="POST">
				...
				<div class="modal-footer">
					...
					<input name="type" type="hidden" value="fall" />
					<a href="#" class="btn btn-default" data-dismiss="modal">取消</a>
...
$(function(){
	...
	$("#modalSubmit").click(function(){
        ...
        var options= {
                url : "/Examine/ajaxFallAddOrUpdate",
                dataType:  'json',//数据类型
...
function opUpdate(row){
	...
	var inputArr = ['event_time','report_name','report_time','event_type','patient',
	                'anamnesis_num','patient_age','patient_diagnosis','party_name',
	                'party_title','working_years','shift'];
	for(var i=0;i< inputArr.length;i++){
	...
	var radioArr = ['incident_link','incident_location','pre_incident_state','functional_impairment','pre_patient_state',
	                'after_patient_state','injury_classification','patient_gender','patient_type','patient_position',
	                'patient_edu','governance_capability','escort','patient_response'];

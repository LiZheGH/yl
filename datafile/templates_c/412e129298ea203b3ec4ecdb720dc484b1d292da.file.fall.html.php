<?php /* Smarty version Smarty-3.1.13, created on 2017-10-14 20:31:58
         compiled from "/private/var/www/yl/application/views/admin/abnormal/fall.html" */ ?>
<?php /*%%SmartyHeaderCode:130092519959e203be2ca853-79712821%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '130092519959e203be2ca853-79712821',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59e203be32c199_85645906',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59e203be32c199_85645906')) {function content_59e203be32c199_85645906($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['VIEW_DIR']->value)."common/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
	...
	<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
      <div class="portlet box blue-madison">
        <div class="portlet-title">
          <div class="caption"> <i class="fa fa-globe"></i>异常事件上报-跌倒坠床报告</div>
        </div>
        <div class="portlet-body">
		   ...
		   <table id="tableId" data-url="/Abnormal/ajaxFallList" data-sort-name="id" data-sort-order="desc" data-toggle="table"
...
$(function(){
	...
	$("#modalSubmit").click(function(){
        ...
        var options= {
                url : "/Abnormal/ajaxFallAddOrUpdate",
                dataType:  'json',//数据类型
...
function downExcel(){
	...
	if(!ids || ids == ''){
		...
		window.location.href = '/Abnormal/ajaxAbnormalDownExcel/type/fall/ids/'+ids;
	}
}
</script>

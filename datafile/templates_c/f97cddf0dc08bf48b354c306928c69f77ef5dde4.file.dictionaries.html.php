<?php /* Smarty version Smarty-3.1.13, created on 2017-10-05 23:43:04
	...
	<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
      <div class="portlet box blue-madison">
        ...
        <div class="portlet-body">
		   ...
		   <table id="tableId" data-url="/Standard/ajaxDictionaryList" data-sort-name="id" data-sort-order="desc" data-toggle="table"
...
function operateFormatter(value, row, index) {
    return [
        ...
        '</a> ',
        '<a class="add ml10" href="javascript:void(0)" title="Edit">',

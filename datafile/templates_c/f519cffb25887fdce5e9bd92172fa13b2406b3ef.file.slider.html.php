<?php /* Smarty version Smarty-3.1.13, created on 2017-10-03 22:56:53
         compiled from "/private/var/www/yl/application/views/admin/goodsIndex/slider.html" */ ?>
<?php /*%%SmartyHeaderCode:36033833259d3a535952c48-72159467%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f519cffb25887fdce5e9bd92172fa13b2406b3ef' => 
    array (
      0 => '/private/var/www/yl/application/views/admin/goodsIndex/slider.html',
      1 => 1506342841,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '36033833259d3a535952c48-72159467',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59d3a535979307_17645427',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59d3a535979307_17645427')) {function content_59d3a535979307_17645427($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['VIEW_DIR']->value)."common/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<script type="text/javascript">	
	...
	function showModal() {
		$.ajax({
	        url:'/goodsIndex/ajaxGoodsIndexJudge',
	        type:'post',
			dataType : 'json',
			data : encodeURI('type=3'),
			async: false,
			success:function(data){
	        	if(!data['success']) {
	        		alert(data['msg']);
    ...
    <div class="page-content">
      ...
      <div class="portlet box blue-madison">
        <div class="portlet-title">
          <div class="caption"> <i class="fa fa-globe"></i>滑动模块商品 </div>
        ...
        <div class="portlet-body">
			...
			<table id="tableId" data-url="/goodsIndex/ajaxGoodsIndexList/type/3" data-toggle="table"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" id="oneForm" class="form-horizontal">	
                	...
                	<div class="form-group">
	                    <label for="first_level" class="col-sm-2 control-label">商品图片(180*181)</label>
	                    <div class="col-sm-9" style="margin-top:7.5px;">
...
function refresh()
{
	$('#tableId').bootstrapTable('refresh', {
        url: '/goodsIndex/ajaxGoodsIndexList/type/3'
    });
}
...
function addGoods(){
	...
	$.ajax({
        ...
        type:'post',
		dataType : 'json',
		data : encodeURI('goods_id=' + goods_id + '&image=' + image + '&sort=' + sort + '&type=3'),
		async:false,
        success:function(data){
        	if(data['success']) {
        		refresh();

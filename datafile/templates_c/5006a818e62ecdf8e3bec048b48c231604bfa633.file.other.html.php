<?php /* Smarty version Smarty-3.1.13, created on 2017-10-15 05:26:33
         compiled from "/private/var/www/yl/application/views/admin/examine/other.html" */ ?>
<?php /*%%SmartyHeaderCode:92633126459e28109ba7d32-97143166%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5006a818e62ecdf8e3bec048b48c231604bfa633' => 
    array (
      0 => '/private/var/www/yl/application/views/admin/examine/other.html',
      1 => 1507869135,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '92633126459e28109ba7d32-97143166',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59e28109c00890_55788349',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59e28109c00890_55788349')) {function content_59e28109c00890_55788349($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['VIEW_DIR']->value)."common/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
	...
	<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
      <div class="portlet box blue-madison">
        <div class="portlet-title">
          <div class="caption"> <i class="fa fa-globe"></i>异常事件审核-其他事件报告</div>
        </div>
        <div class="portlet-body">
        	<div id="toolbar1" style="margin-bottom:0px;">
				<!-- <button class="btn btn-primary btn-sm" onClick="showModal();">&nbsp;&nbsp;新增&nbsp;&nbsp;</button> -->
		   	</div>
		   <table id="tableId" data-url="/Examine/ajaxOtherList" data-sort-name="id" data-sort-order="desc" data-toggle="table"
...
$(function(){
	...
	$("#modalSubmit").click(function(){
        ...
        var options= {
                url : "/Examine/ajaxOtherAddOrUpdate",
                dataType:  'json',//数据类型

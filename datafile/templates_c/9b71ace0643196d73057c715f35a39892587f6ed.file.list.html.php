<?php /* Smarty version Smarty-3.1.13, created on 2017-10-03 22:56:55
         compiled from "/private/var/www/yl/application/views/admin/goodsIndex/list.html" */ ?>
<?php /*%%SmartyHeaderCode:64997352759d3a5375c24c8-26399662%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9b71ace0643196d73057c715f35a39892587f6ed' => 
    array (
      0 => '/private/var/www/yl/application/views/admin/goodsIndex/list.html',
      1 => 1506342841,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '64997352759d3a5375c24c8-26399662',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59d3a5375ea340_86268730',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59d3a5375ea340_86268730')) {function content_59d3a5375ea340_86268730($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['VIEW_DIR']->value)."common/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
    ...
    <div class="page-content">
      ...
      <div class="portlet box blue-madison">
        ...
        <div class="portlet-body">
			...
			<table id="tableId" data-url="/goodsIndex/ajaxGoodsIndexList/type/4" data-toggle="table"
...
function refresh()
{
	$('#tableId').bootstrapTable('refresh', {
        url: '/goodsIndex/ajaxGoodsIndexList/type/4'
    });
}
...
function addGoods(){
	...
	$.ajax({
        ...
        type:'post',
		dataType : 'json',
		data : encodeURI('goods_id=' + goods_id + '&image=' + image + '&sort=' + sort + '&type=4'),
		async:false,
        success:function(data){
        	if(data['success']) {
        		refresh();
